...
public class Meeting
{
    ...
    public Meeting(long id, long neighborhoodId, MeetingTheme theme, TimeOnly meetingTime,
        DateOnly dateRangeStart, DateOnly dateRangeEnd, MeetingStatus status, DateOnly? scheduledDate)
    {
        Id = id;
    ...
    public Meeting(long neighborhoodId, MeetingTheme theme, TimeOnly meetingTime,
        DateOnly dateRangeStart, DateOnly dateRangeEnd)
    {
        Id = 0;
        NeighborhoodId = neighborhoodId;
        Theme = theme;
