...
using CommunityHub.Application.Domain.RepositoryInterfaces.Neighborhoods.Budget;

namespace CommunityHub.Application.Database.Repositories.Neighborhoods.Budget;
