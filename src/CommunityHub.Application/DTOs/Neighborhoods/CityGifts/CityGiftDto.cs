namespace CommunityHub.Application.DTOs.Neighborhoods.CityGifts;
...
public class CityGiftDto
{
    ...
    public bool CoordinatorAlreadyApplied { get; init; }
    ...
    public CityGiftDto(long id, decimal amount, string deadline, bool isAwarded,
        ...
        bool coordinatorAlreadyApplied = false)
    {
        Id = id;
        Amount = amount;
        ...
        CoordinatorAlreadyApplied = coordinatorAlreadyApplied;
    }
    ...
    public string StatusDisplay => IsAwarded
        ...
        : HasApplied ? "✔ Applied"
        : CoordinatorAlreadyApplied ? "✔ Applied with another neighborhood"
